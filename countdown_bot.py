...
# Настройки
BOT_TOKEN = os.getenv("BOT_TOKEN")  # В Render укажешь в Environment Variables
...
async def setstart(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Установить дату и время первого напоминания."""
...
async def settime(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Изменить время ежедневных напоминаний."""
    chat_id = update.effective_chat.id
    if not context.args:
